...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{\de{Funktionen können Variablen zugewiesen werden}\en{Functions can be assigned to variables}}
\onslide+<2->
JavaScript:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{\de{Funktionen können als Funktionsparameter übergeben werden}\en{Functions can be passed as function parameters}}
\onslide+<2->
JavaScript:
\begin{lstlisting}{javascript}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{\de{Funktionen können von Funktionen zurückgegeben werden}\en{Functions can be returned from functions}}
\onslide+<2->
JavaScript:
\begin{lstlisting}{javascript}
...
\onslide*<2>{
\item Nimmt eine Collection, eine Funktion und einen Startwert
\item Verbindet Startwert und erstes Element der Collection mit Hilfe der Funktion
\item Verbindet das Ergebnis mit dem nächsten Element der Collection
