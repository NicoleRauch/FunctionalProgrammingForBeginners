...
\begin{itemize}
\onslide+<2->
\item \de{\glqq{}alles, was den Ablauf eines Computerprogramms oder die Außenwelt verändert, ohne von einer Funktion berechnet worden zu sein\grqq{}} \en{``everything that changes the execution of a computer program or the outside world without being calculated in a function''}
...
\item \de{Nichtdeterminismus (z. B. Zufallszahlengenerator)} \en{Nondeterminism (e.g.~random number generator)}
\end{itemize}
...
\begin{frame}{\de{Vielen Dank!}\en{Thank you very much!}}
        ...
        \de{
        \begin{itemize}
	\item Artikel in der Java Aktuell 01/2016
