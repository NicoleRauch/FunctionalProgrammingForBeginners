...
\onslide+<4->
\begin{center}
\de{In Java nicht direkt unterstützt}
\end{center}

\onslide+<5->
\begin{center}
\de{Kann trotzdem leicht verwirklicht werden:}
\end{center}
...
\onslide+<3->
\begin{center}
\de{\glqq{}alles, was den Ablauf eines Computerprogramms oder die Außenwelt verändert, ohne von einer Funktion zurückgegeben worden zu sein\grqq{}}
\end{center}
...
\onslide+<5->
\begin{center}
\de{Manche Sprachen zeigen das Vorhandensein von Seiteneffekten sogar in der Typsignatur an}
\end{center}
